...
export default function ProductPage() {
    ...
    const [product, setProduct] = useState<Product & { extra_images: ProductImage<null>[] } | null>(null);

    useEffect(() => {
        axios.get<{ product: Product & { extra_images: ProductImage<null>[] } }>(`/api/admin/products/${router.query.slug}`)
            .then(response => {
