        ...
        <>
            {
                (!user || isPending)
                    ...
                    :
                    <main className="flex flex-col w-full overflow-y-hidden md:flex-row md:h-screen font-sans">
                        <div className="">
                            <DashboardSidebar />
                        </div>

                        <div
                            className={`flex h-screen flex-col justify-between py-2 flex-auto w-full overflow-y-auto `}
                        >
                            <div className="mx-2 p-10 rounded-2xl">
                                ...
                                <button>
                                    ...
                                    <label className="swap swap-rotate">
                                        ...
                                        <input type="checkbox" onChange={(e) => { handleToggle(e.target.checked) }} />
