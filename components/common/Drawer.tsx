            ...
            <Dialog as="div" className="fixed inset-0 overflow-hidden" onClose={onClose}>
                <div className="absolute inset-0 overflow-hidden">
                    <Transition.Child
                        ...
                        leaveTo="opacity-0"
                    >
                        <Dialog.Overlay className="absolute inset-0 blur-lg bg-neutral-content bg-opacity-5 transition-opacity" />
                    </Transition.Child>
                                    ...
                                    <div className="px-4 sm:px-6">
                                        <div className="flex items-start justify-between">
                                            ...
                                            <div className="ml-3 h-7 flex items-center">
                                                <button
                                                    type="button"
                                                    className="rounded-md text-neutral-content font-bold"
                                                    onClick={onClose}
                                                >
